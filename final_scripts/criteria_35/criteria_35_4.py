...
try:
    ...
    from criteria_35_get_test_point_list import get_test_point_list
    from criteria_35_get_component_pads_info import get_component_pads_info as get_pad_list
